...
public class Table extends javax.swing.JFrame {
    ...
    private Connection conn = Deposito.getConnection();
    ...
    public ArrayList<DepositoTable> getList() {
        ArrayList<DepositoTable> depositoList = new ArrayList<DepositoTable>();
        String find = jTextField1.getText();
        try {
            DepositoTable dep;
            if (find.equals(null)) {
                stmt = conn.prepareStatement("select * from deposito order by dep_id desc;");
            } else {
                stmt = conn.prepareStatement("select * from deposito;");
            }
...
//
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ALL", "ARO", "TT" }));
